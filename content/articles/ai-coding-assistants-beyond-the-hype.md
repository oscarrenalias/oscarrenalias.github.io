...
description = "Celebrating % of AI-generated code misses the point. The real value is elevating engineers from code writers to quality guardians."
+++

## The Promise and Hype of AI Coding Assistants

There’s a major push around AI coding assistants. They’re advancing rapidly and, in my opinion, are essential for the software engineering organization of the future. By automating non-differentiating boilerplate and commoditized code, they free engineers to concentrate on the most important, differentiating areas of applications and systems.

Yet despite this clear value proposition, in the rush to embrace coding assistants, it seems we're all caught up in the hype. Companies like Coinbase are proudly showcasing that 40% of their code is AI-generated but is this really a good thing? Aiming at a magic figure is plain silly, and I'd caution everyone to step back and think about what we're actually doing.

## Reality Check: Limitations and Risks

Tools like GitHub Copilot's coding agent (that I have some experience with and I really like) promise to offload repetitive tasks, allowing developers to focus on "higher-level problem-solving." That's the vision but in reality, these coding assistants often need a guiding hand; they write code at lightning speed, but in my experience they don't understand when to refactor, when the code is optimal or not, or when to simply reuse existing libraries and avoid reinventing the wheel. It's like having the most expert and fastest code writer in the world, but with zero sense of quality or code craftmanship. Quality, performance modularity, etc, these are basic software engineering concerns that some companies seem to be willing to overlook in exchange for speed.
